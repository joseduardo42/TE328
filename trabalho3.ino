...
//faz a leitura da porta analógica e incrementa a variavel de quantidade de
valores lidos
val_leitura[posicao_atual] = (analogRead(A0)*5)/1023;
qtd_val += 1;
...
lcd.setCursor(10,0);
lcd.print(qtd_val);
//printa a quantidade de valores sobrescritos com 2 casas decimais no display
LCD
lcd.setCursor(13,0);
